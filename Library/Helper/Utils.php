...
class Utils
{
    ...
    public static function placeholderReplace($content, $params)
    {
        ...
        $content = str_replace(
            ...
            [SITE_NAME, $params['nickname'], $params['email'], $params['code'], $params['newPassword'], $params['useTraffic'], $params['transfer'], $params['expireTime'], $params['REGISTER_URL'], $params['beInvited'], $params['inviteBonus']],
            $content);
